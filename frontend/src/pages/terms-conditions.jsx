...
const TermsConditions = () => {
    const content = (
        <>
            ...
            <p className="mb-20">Welcome to rbcbank. These Terms and Conditions govern your access to and use of the Rcb Royale Bank account management platform. By creating an account or using this website, you agree to comply with the terms stated below.</p>
            
            <h4 className="text-slate-900 font-black mt-30 mb-15">1. Platform Purpose</h4>
            <p className="mb-20">rbcbank provides an online account management system for registered traders and investment participants. The platform allows users to:</p>
            ...
            <p className="mb-20">rbcbank does not guarantee trading profits or fixed returns.</p>

            <h4 className="text-slate-900 font-black mt-30 mb-15">2. Eligibility</h4>
            <p className="mb-20">By registering on rbcbank, you confirm that:</p>
            <ul className="mb-20 list-disc ml-20">
                <li>You are at least 18 years old.</li>
                <li>The information you provide is accurate and complete.</li>
                <li>You are legally allowed to participate in investment activities under your local laws.</li>
            </ul>
            <p className="mb-20">rbcbank reserves the right to refuse or terminate accounts that provide false information.</p>
            ...
            <p className="mb-20">Users may fund their accounts using approved payment methods. All transactions recorded on the platform are considered valid unless proven otherwise. Processing times may vary depending on payment providers. rbcbank is not responsible for delays caused by third-party payment systems.</p>
            ...
            <p className="mb-20">rbcbank may suspend or close accounts if: Terms are violated, Fraudulent activity is suspected, Required verification is not completed. Balances may be reviewed before account closure.</p>

            <h4 className="text-slate-900 font-black mt-30 mb-15">9. Privacy</h4>
            <p className="mb-20">Your personal information is collected only for account management, communication, and security purposes. rbcbank does not sell user data to third parties.</p>

            <h4 className="text-slate-900 font-black mt-30 mb-15">10. Limitation of Liability</h4>
            <p className="mb-20">rbcbank shall not be held liable for: Trading losses, Market fluctuations, Service interruptions beyond reasonable control, Third-party payment or technical failures.</p>

            <h4 className="text-slate-900 font-black mt-30 mb-15">11. Changes to Terms</h4>
            <p className="mb-20">rbcbank may update these Terms and Conditions at any time. Continued use of the platform after updates means you accept the revised terms.</p>
