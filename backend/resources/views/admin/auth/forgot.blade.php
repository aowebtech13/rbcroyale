    ...
    <div class="max-w-md w-full bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 p-10 lg:p-12 border border-slate-200">
        ...
        <form action="{{ route('admin.password.forgot') }}" method="POST" class="space-y-8">
            ...
            <div class="form-control">
                ...
                <input type="email" name="email" class="input border-slate-200 rounded-2xl bg-slate-50 font-bold focus:bg-white focus:border-slate-900 focus:ring-4 focus:ring-slate-900/5 transition-all h-14" placeholder="admin@lexicrone.com" required />
            </div>
